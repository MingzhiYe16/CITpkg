...
// [[Rcpp::export]]
void citbinmcvr(Rcpp::NumericVector L, Rcpp::NumericVector G, Rcpp::NumericVector T, Rcpp::NumericVector C,
				...
				Rcpp::NumericVector pval1, Rcpp::NumericVector pval2, Rcpp::NumericVector pval4, Rcpp::NumericVector pval3nc, int &rseed)
{
	...
	for (rw = 0; rw < nrow; rw++)
	{
		...
		if (aa && bb && cc && dd)
		{
			...
			for (cl = 0; cl < dfx; cl++)
			{
				gsl_matrix_set(Gm, rind, cl, GG[rw][cl]);
			}
